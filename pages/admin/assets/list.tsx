  ...
  render() {
    ...
    return (
      <div className="flex justify-center">
        <div className="w-2/3">
          <h1 className="ml-5 font-bold"><span>😬</span>DB Info</h1>
          ...
          <tr key={d['id']}>
            ...
            </td>
            {
              this.state.dbHeaders!.map(h => {
                ...
                return <td className="px-1 min-w-fit max-w-md truncate border-l-2 border-t-2 border-yellow-400" title={show} key={d['id'] + '_' + acc} >{ show }</td>
              })
            }
          </tr>
        )
