...
export default async function Handler(req: NextApiRequest, res: NextApiResponse<ApiResponse<string | { xp: number; level: number; nextLevelXP: number; } | { cid: string; } | string[]>>) {
