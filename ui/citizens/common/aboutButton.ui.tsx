...
export default function AboutButton({ className = '', onClick }: AboutButtonProps) {
  ...
  return (
    ...
    >
      ...
      <div className="w-[214px] h-[46px] bg-[#1B1B1D] rounded-[20px] relative overflow-hidden transition-all duration-200 hover:bg-[#252527]"
           style={{
        ...
        <div className="absolute left-1/2 top-1/2 -translate-x-1/2 -translate-y-1/2">
          <span className="font-work font-light text-[18px] leading-[100%] text-center text-white">
            ABOUT
          </span>
        </div>
        
        {/* Small rounded border element (expand/collapse indicator) */}
        <div className="absolute right-[9px] top-1/2 -translate-y-1/2 w-[40px] h-[27px] border border-[#BCBCBC] rounded-[19px] flex items-center justify-center transition-all duration-200">
