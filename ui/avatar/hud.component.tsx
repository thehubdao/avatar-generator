        ...
        editModeSelected ?
          <div className="fixed inset-0 w-[58%] h-screen bg-bg hidden xl:block">
            ...
            <div className="fixed flex right-0 top-0 justify-center items-center gap-1 py-3 px-8 max-w-lg">
              <div className="-z-10 absolute -left-10 h-full w-[150%] skew-x-[45deg] bg-bg" />
              <div className="">
                <Image src={'https://thehubdao.xyz/thehub.svg'} width={0} height={0} style={{ width: 'auto', height: 'auto' }} alt="the hub icon" />
              </div>
            </div>
            {/* WRAPPER */}
