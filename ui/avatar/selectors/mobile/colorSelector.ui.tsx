...
export default function ColorSelectorUI({ list, activeColor, handleChangeColor, handleSwitchShowColorSelector }: ColorSelectorUIProps) {
  return (
    <div className='w-full relative h-screen flex justify-center items-center'>
      ...
      <div className='w-[80vw] h-[70vh] bg-bg dark:bg-citizens-dark rounded-2xl z-10 flex flex-col justify-around items-stretch'>
        <h2 className='w-full text-center text-3xl text-gray-normal dark:text-gray-light font-poppins'>SKIN COLOR</h2>
